...
class Nav extends Component {
  ...
  render() {
    ...
    //   : { backgroundColor: bgPrimary, color: colorPrimary }; // TODO COLOR
    return (
      <nav
        ...
        // style={stickyStyles} TODO THEME / COLOR
      >
        <div className="magic-wand bounce-xy" onClick={(e) => alert("Theme switcher")}>
          {" "}
          THEME SWITCHER
