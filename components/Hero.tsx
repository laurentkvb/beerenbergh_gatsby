...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-16 bg-gradient-to-b from-white via-[#fafafa] to-white">
